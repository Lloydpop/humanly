...
import scene1 from "../../../../public/img/gt-4.jpg";
import scene2 from "../../../../public/img/gt-2.jpg";
import scene3 from "../../../../public/img/gt-3.jpg";
      ...
      <div className="grid grid-cols-12 h-[100vh]">
        <div className="col-span-5 h-full relative overflow-hidden">
          <div className="w-full h-full flex flex-col p-7 dark:text-white z-[1000] text-white  bg-[#000000a2] absolute top-0 left-0">
            <div>
             <div> <p className="uppercase text-right text-sm flex justify-between items-center"> <ArrowLeft onClick={()=>back()} className="cursor-pointer"/>[ project 6 ]</p></div>
            </div>
            <h1 className="text-[80px] uppercase font-[500] tracking-tighter pt-[100px]">
              GTCO
            </h1>
            <div>
              <div className="mt-40">
          ...
          >
            <source src="/gtco.mp4" type="video/mp4" />
        ...
        <div className="col-span-7 h-[100vh] overflow-y-auto p-8">
          ...
          <h1 className="font-[500] text-[22px] mt-40 font-inter">
           This project brought GTCO’s vision to life through bold storytelling and immersive creative direction. Humanly transformed the streets of Lagos into a living canvas—merging culture, community, and innovation into a vibrant experience. From concept to execution, every detail was designed to reflect GTCO’s identity while celebrating the city’s spirit. The result was not just an activation, but a dynamic showcase of creativity’s power to connect people and reimagine spaces.
          </h1>
          <div>
...
<div className="flex justify-between mt-48">
  ...
  <div>
    ...
    >
      <source src="/reu.mp4" type="video/mp4" />
      Your browser does not support the video tag.
    </video>
  </div>
</div>
