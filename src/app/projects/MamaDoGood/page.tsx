...
import scene1 from "../../../../public/img/mama-1.jpg";
import scene2 from "../../../../public/img/mama-2.jpg";
import scene3 from "../../../../public/img/mama-3.jpg";
...
const MamaDoGood= () => {
  ...
  return (
      ...
      <div className="grid grid-cols-12 h-[100vh]">
        <div className="col-span-5 h-full relative overflow-hidden">
          <div className="w-full h-full flex flex-col p-7 dark:text-white z-[1000] text-white  bg-[#000000a2] absolute top-0 left-0">
            <div>
             <div> <p className="uppercase text-right text-sm flex justify-between items-center"> <ArrowLeft onClick={()=>back()} className="cursor-pointer"/>[ project 5 ]</p></div>
            </div>
    ...
    Indomie “Mama Do Good” Project (Executed by Humanly)
Humanly brought the “Mama Do Good” campaign to life by celebrating the warmth, care, and love that go into every meal. The project highlighted Indomie as more than just a quick meal—it’s a symbol of home, comfort, and the joy of sharing. Through creative storytelling and engaging visuals, we captured authentic moments that connect with families, turning simple everyday meals into memorable experiences.
          </h1>
          <div>
