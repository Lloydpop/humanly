      ...
      <div className="grid grid-cols-12 h-[100vh]">
        <div className="col-span-5 h-full relative overflow-hidden">
          <div className="w-full h-full flex flex-col p-7 dark:text-white z-[1000] text-white  bg-[#000000a2] absolute top-0 left-0">
            <div>
             <div> <p className="uppercase text-right text-sm flex justify-between items-center"> <ArrowLeft onClick={()=>back()} className="cursor-pointer"/>[ project 2 ]</p></div>
            </div>
        ...
        <div className="col-span-7 h-[100vh] overflow-y-auto p-8">
          ...
          For Ramadan, Humanly crafted a campaign that celebrated the spirit of togetherness, warmth, and shared meals. We highlighted Maggi as an essential part of bringing families and communities together during this sacred month. Through storytelling rooted in authentic moments, familiar kitchens became vibrant spaces of connection, culture, and celebration—turning every meal into a cherished memory.
          </h1>
          <div>
